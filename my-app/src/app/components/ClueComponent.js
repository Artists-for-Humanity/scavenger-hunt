        ...
        if (clueNumber === totalClues) {
            ...
            return (
                <main className="flex min-h-screen flex-col items-center justify-between p-6 pt-12 text-center bg-afhNight">
                    <Confetti gravity={gravity} numberOfPieces={number} />
                    <div className="w-full h-6 rounded-full bg-white relative">
                    ...
                    <h1 className="mb-4 mt-48 text-4xl text-white font-bold font-verdana ">Congrats! You finished the Holiday Hunt!</h1>
                    ...
                    <a href="https://www.afhboston.org/donate" className=" mb-10 text-whitee	 text-xl font-verdana underline decoration-dotted">Donate to AFH</a>
            ...
            <main className="flex min-h-screen flex-col items-center justify-between p-6 pt-12 text-center bg-afhNight">
                <div className="w-full h-6 rounded-full bg-white relative">
                    <div className="h-6 rounded-full bg-customGreen"
                        style={{ width: `${progress}%`, transition: 'width 0.5s ease-in-out' }}></div>
                    {/* <div className="absolute top-6 right-0 mr-2 text-white text-sm">{clueNumber}/{totalClues}</div> */}
                    <div className="absolute top-6 right-0 mr-2  text-white text-sm pt-1">{clueNumber}/{totalClues}</div>
                </div>
